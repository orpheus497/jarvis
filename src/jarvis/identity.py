...
class IdentityManager:
    ...
    def create_identity(self, username: str, password: str, listen_port: int = 5000) -> Identity:
        """
    ...
    def save_identity(self, password: str) -> None:
        ...
        try:
            ...
            raise OSError(f"Failed to save identity: {e}") from e
    ...
    def export_complete_account(
        self, password: str, export_path: str, contact_manager, message_store, group_manager
    ) -> bool:
        """
        ...
        try:
            ...
            export_data = {
                ...
                "contacts": {
                    uid: contact.to_dict() for uid, contact in contact_manager.contacts.items()
                },
                "groups": {},
                "messages": {},
            }
            ...
            if hasattr(group_manager, "groups"):
                export_data["groups"] = {
                    gid: group.to_dict() for gid, group in group_manager.groups.items()
                }
            ...
            if hasattr(message_store, "get_all_messages"):
                ...
                logger.debug("Exported messages")
