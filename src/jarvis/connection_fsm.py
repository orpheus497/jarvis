...
class ConnectionStateMachine:
    ...
    def is_valid_transition(self, from_state: ConnectionState, event: ConnectionEvent) -> bool:
        ...
        """
        return (from_state in self.TRANSITIONS and 
                event in self.TRANSITIONS[from_state])
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        if len(self.transition_history) >= 2:
            for i in range(len(self.transition_history) - 1):
                ...
                duration = (self.transition_history[i + 1].timestamp - 
                           self.transition_history[i].timestamp)
    ...
    def __repr__(self) -> str:
        ...
        return (f"ConnectionStateMachine(state={self.current_state.name}, "
